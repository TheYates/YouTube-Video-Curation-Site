...
// Pure matching utilities. They operate on any Video[] — the Supabase-backed
// hooks map rows to Video first, then reuse these. (Moved here from the old
// mock data module so they survive the mock's deletion.)
