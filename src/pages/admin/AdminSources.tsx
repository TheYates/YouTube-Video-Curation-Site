...
interface StoredOverride {
  added: SourceChannel[]
  removed: string[] // "category|handle" keys of builtins the curator removed
}
...
export default function AdminSources() {
  ...
  // User-added channels first, then builtins (minus removed ones).
  ...
  function handleAdd(e: React.FormEvent) {
    ...
    persist({
      ...overrides,
      added: [
        { name: name.trim(), handle: cleanHandle, category, description: description.trim() || "Curator pick", builtin: false },
        ...overrides.added,
      ],
    })
    setName("")
